# SysML 2.0 Metamodel 0.57.0 Mappings

These files are part of the `sysml-2.0-metamodel-0.57.0` metamodel.

`metamodel_constructs.seed.json` maps textual parser constructs and keywords to
SysML/KerML metaclasses.
...
1. `metamodel_constructs.seed.json` identifies language constructs and metaclasses.
