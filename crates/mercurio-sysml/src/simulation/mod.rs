...
use mercurio_foundation::runtime::{Runtime, RuntimeError};
pub use mercurio_foundation::simulation_core::{
...
fn constraint_analysis_report(
    ...
    crate::SysmlConstraintAnalysisCapability
        .run(
            &workspace,
...
fn semantic_ref_from_analysis_ref(
    reference: &mercurio_foundation::analysis::AnalysisElementRef,
) -> SemanticElementRef {
    reference.clone()
}

fn analysis_ref_payload(reference: &mercurio_foundation::analysis::AnalysisElementRef) -> Value {
    serde_json::json!({
