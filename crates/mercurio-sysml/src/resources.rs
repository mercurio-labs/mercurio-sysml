...
pub static KERML_KERNEL: &str = include_str!("../resources/kernel/kerml-kernel.kir.json");
pub static METAMODEL_REGISTRY: &str = include_str!("../resources/metamodels/registry.json");
...
pub static SYSML_057_LIBRARY: &[u8] = include_bytes!(
...
pub static SYSML_057_FULL_STDLIB: &[u8] = include_bytes!(
...
pub static SYSML_057_RULEPACK: &str =
    include_str!("../resources/metamodels/sysml-2.0-metamodel-0.57.0/stdlib/stdlib.rulepack.json");
pub static SYSML_2026_04_RULEPACK: &str =
    include_str!("../resources/metamodels/sysml-2.0-pilot-2026-04/stdlib/stdlib.rulepack.json");
...
pub fn metamodel_constructs(id: &str) -> Option<&'static str> {
    match id {
        ...
        SYSML_2_0_PILOT_2026_04_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-pilot-2026-04/mappings/metamodel_constructs.seed.json"
        )),
        _ => None,
    }
}
...
pub fn kir_emission(id: &str) -> Option<&'static str> {
    match id {
        ...
        SYSML_2_0_PILOT_2026_04_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-pilot-2026-04/mappings/kir_emission.seed.json"
        )),
        _ => None,
    }
}
...
pub fn lowering_rules(id: &str) -> Option<&'static str> {
    match id {
        ...
        SYSML_2_0_PILOT_2026_04_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-pilot-2026-04/mappings/lowering_rules.seed.json"
        )),
        _ => None,
    }
}
...
pub fn semantic_defaults(id: &str) -> Option<&'static str> {
    match id {
        ...
        SYSML_2_0_PILOT_2026_04_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-pilot-2026-04/mappings/semantic_defaults.seed.json"
        )),
        _ => None,
    }
}
...
pub fn field_specs_generated(id: &str) -> Option<&'static str> {
    match id {
        SYSML_2_0_METAMODEL_057_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-metamodel-0.57.0/mappings/field_specs.generated.json"
        )),
        SYSML_2_0_PILOT_2026_04_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-pilot-2026-04/mappings/field_specs.generated.json"
        )),
        _ => None,
    }
}
...
pub fn field_specs_overlay(id: &str) -> Option<&'static str> {
    match id {
        SYSML_2_0_METAMODEL_057_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-metamodel-0.57.0/mappings/field_specs.overlay.json"
        )),
        SYSML_2_0_PILOT_2026_04_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-pilot-2026-04/mappings/field_specs.overlay.json"
        )),
        _ => None,
    }
}
...
pub fn grammar_extract(id: &str) -> Option<&'static str> {
    match id {
        SYSML_2_0_METAMODEL_057_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-metamodel-0.57.0/grammar.extract.json"
        )),
        SYSML_2_0_PILOT_2026_04_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-pilot-2026-04/grammar.extract.json"
        )),
        _ => None,
    }
}
...
pub fn metamodel_extract(id: &str) -> Option<&'static str> {
    match id {
        SYSML_2_0_METAMODEL_057_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-metamodel-0.57.0/metamodel.extract.json"
        )),
        SYSML_2_0_PILOT_2026_04_ID => Some(include_str!(
            "../resources/metamodels/sysml-2.0-pilot-2026-04/metamodel.extract.json"
        )),
        _ => None,
    }
}
...
mod tests {
    ...
    fn aliased_release_libraries_match_provenance_files() {
        assert_eq!(
            SYSML_057_LIBRARY,
            include_bytes!(
                "../resources/metamodels/sysml-2.0-pilot-2026-04/stdlib/sysml-library.kir.json"
            )
        );
        assert_eq!(
            SYSML_057_FULL_STDLIB,
            include_bytes!(
                "../resources/metamodels/sysml-2.0-pilot-2026-04/stdlib/stdlib.full.kir.json"
            )
        );
    }
}
